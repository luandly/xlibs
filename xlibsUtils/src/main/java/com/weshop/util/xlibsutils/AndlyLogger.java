 ...
 * 自定义Log打印工具类
 */
public class AndlyLogger {
    /**
     * log tag
     */
    private String tagName = "AndlyLogger";// tag name
    private static int logLevel = Log.VERBOSE;
    //private static int logLevel = Log.ERROR;
    //private static int logLevel = Log.DEBUG;

    private static AndlyLogger inst;
    private Lock lock;
    ...
    public static synchronized AndlyLogger getLogger(Class<?> key) {
        if (inst == null) {
            inst = new AndlyLogger();
        }
        return inst;
    }
